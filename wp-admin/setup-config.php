...
if ( version_compare( $required_php_version, phpversion(), '>' ) )
	wp_die( sprintf( /*WP_I18N_OLD_PHP*/'На сервере установлен PHP версии %1$s, однако для WordPress требуется хотя бы %2$s.'/*/WP_I18N_OLD_PHP*/, phpversion(), $required_php_version ) );
